  ...
  try {
    ...
    */
    ...
    const token = jwt.sign(
      { id: user.id || user._id.toString(), username: user.username, email: user.email, avatar: user.avatar, auth_provider: user.auth_provider, email_verified: user.email_verified },
      config.jwt_secret,
